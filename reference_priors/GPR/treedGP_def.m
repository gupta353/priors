...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% region 13
ind = find(Xtrain(:,3)<=-5 & Xtrain(:,2)>0.04 & Xtrain(:,2)<=0.12 & Xtrain(:,4)>2);
Xtrain_r = Xtrain(ind,:);
ytrain_r = ytrain(ind,:);
stand_dev = std(Xtrain_r);
m = mean(Xtrain_r);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% define regions
region_def = @(x)[(x(:,3)>-5 & x(:,2)>0.04 & x(:,1)>50),...
    (x(:,3)>-5 & x(:,2)>0.04 & x(:,1)<=50),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)>1 & x(:,4)>1),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)>1 & x(:,4)<=1 & x(:,4)>0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)>1 & x(:,4)<=0.2 & x(:,4)>0.04),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)>1 & x(:,4)<=0.04),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=1 & x(:,2)>0.2 & x(:,4)>2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=1 & x(:,2)>0.2 & x(:,4)<=2 & x(:,4)>0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=1 & x(:,2)>0.2 & x(:,4)<=0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.2 & x(:,2)>0.12 & x(:,4)>2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.2 & x(:,2)>0.12 & x(:,4)<=2 & x(:,4)>0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.2 & x(:,2)>0.12 & x(:,4)<=0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.12 & x(:,4)>2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.12 & x(:,4)<=2 & x(:,4)>0.2),...
    (x(:,3)<=-5 & x(:,2)>0.04 & x(:,2)<=0.12 & x(:,4)<=0.2)];
