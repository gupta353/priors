...
n_sobol_samps = 777;     % number of latin hypercube samples on each dimension
sample_interval = 39000+1:39000+n_sobol_samps;
n_var = 5;              % number of dimensions (each dimension corresponds to one parameter)
rng(1);

par_range = [1, 2000;...                      % storage capacity (in mm)
    0.06, 0.2;...                              % storage distribution parameter
